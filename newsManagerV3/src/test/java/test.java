...
public class test {
    ...
    @Test
    public void testGetNewsNum(){
        NewsService service = new NewsServiceImpl();
        System.out.println(service.getNewsNum());
    }

    @Test
    public void testGetNewsByPage() {
        NewsService service = new NewsServiceImpl();
        List<News> newsByPage = service.getNewsByPage(3, 1);
        for (News news : newsByPage) {
            System.out.println(news);
        }
    }
    ...
    @Test
    public void testGetNewsByTypeByPage() {
        NewsService service = new NewsServiceImpl();
        List<News> newsByPage = service.getNewsByTypeByPage(1,3, 1);
        for (News news : newsByPage) {
            System.out.println(news);
        }
    }
