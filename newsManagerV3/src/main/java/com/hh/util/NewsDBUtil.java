...
public class NewsDBUtil {
    ...
    public static List<News> getNewsByPage(int pageSize, int pageIndex) {
        List<News> newsInfo = new ArrayList<>();
        String sql = "select newsinfo.id,newsTitle,newsTime,newsContent,newsType.newsType " +
    ...
    public static List<News> getNewsByTypeByPage(int id, int pageSize, int pageIndex) {
        List<News> newsInfo = new ArrayList<>();
        String sql = "select newsinfo.id,newsTitle,newsTime,newsContent,newsType.newsType " +
                "from newsInfo,newsType " +
                "where newsinfo.newsType= newsType.id and newsinfo.newsType=? " +
                "limit ? , ?";
        Connection conn;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
    ...
    public static int getNewsNumByType(int id){
        String sql = "select count(*) from newsinfo where newsType=?";
        int newsNum = 0;
        Connection conn = null;
        PreparedStatement statement = null;
        ResultSet resultSet = null;
